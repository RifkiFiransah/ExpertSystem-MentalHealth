  ...
  <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration">
    <div class="inner">
      <div class="app-card-body p-3 p-lg-4">
        <h3 class="mb-3">Welcome Back, <?= session()->get('username'); ?>!</h3>
        <div class="row gx-5 gy-3">
          <div class="col-12 col-lg-10">
            <div>
              Dashboard pusat kendali dan informasi yang memungkinkan Anda untuk mengelola dan memantau berbagai aspek kesehatan mental dengan efektif. Fitur-fitur unggulan yang disediakan
            </div>
          </div><!--//col-->
        </div><!--//row-->
      </div><!--//app-card-body-->
  ...
  <div class="row g-4 mb-4">
    <div class="col-6 col-lg-3">
      <div class="app-card app-card-stat shadow-sm h-100">
        <div class="app-card-body p-3 p-lg-4">
          <h4 class="stats-type mb-1">Data Penyakit</h4>
          <div class="stats-figure"><?= count($penyakits); ?></div>
        </div><!--//app-card-body-->
        <a class="app-card-link-mask" href="/Penyakit"></a>
      </div><!--//app-card-->
    </div><!--//col-->
    <div class="col-6 col-lg-3">
      <div class="app-card app-card-stat shadow-sm h-100">
        <div class="app-card-body p-3 p-lg-4">
          <h4 class="stats-type mb-1">Data Gejala</h4>
          <div class="stats-figure"><?= count($gejalas); ?></div>
        </div><!--//app-card-body-->
        <a class="app-card-link-mask" href="/Gejala"></a>
      </div><!--//app-card-->
    </div><!--//col-->
    <div class="col-6 col-lg-3">
      <div class="app-card app-card-stat shadow-sm h-100">
        <div class="app-card-body p-3 p-lg-4">
          <h4 class="stats-type mb-1">Data Diagnosa</h4>
          <div class="stats-figure"><?= count($diagnosis); ?></div>
        </div><!--//app-card-body-->
        <a class="app-card-link-mask" href="/Diagnosa"></a>
      </div><!--//app-card-->
    </div><!--//col-->
    <div class="col-6 col-lg-3">
      <div class="app-card app-card-stat shadow-sm h-100">
        <div class="app-card-body p-3 p-lg-4">
          <h4 class="stats-type mb-1">Data Users</h4>
          <div class="stats-figure"><?= count($users); ?></div>
        </div><!--//app-card-body-->
        <a class="app-card-link-mask" href="/User"></a>
      </div><!--//app-card-->
    </div><!--//col-->
